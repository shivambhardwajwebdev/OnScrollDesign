  ...
  <div className="sticky top-0 h-screen overflow-hidden bg-white ">
    ...
    <div className="bg-zinc-300 w-screen h-screen fixed flex-col items-center">
      ...
      <div className="box bg-white  w-screen text-center  " style={{
          minHeight: `${
    window.innerWidth > 768 ? "260px": "250px"
  }`
      }}>
        <div
  style={{
...
>
       <h1
  className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-5xl md:text-6xl lg:text-9xl text-white text-center font-bold "
>
  WELCOME ITZ FIZZ
</h1>
  ...
  transform: `translateX(${
    window.innerWidth > 768 ? progress * 1400 : progress * 600
  }px)`,
  minWidth: `${
    window.innerWidth > 768 ? "260px": "150px"
  }`,
  maxWidth: `${
    window.innerWidth > 768 ? "260px": "150px"
  }`,
